...
(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("@floating-ui/dom")) : typeof define === "function" && define.amd ? define(["@floating-ui/dom"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.coreui = factory(global.FloatingUIDOM));
	...
	*/
	...
	const EVENT_KEY$36 = `.coreui.accordion`;
	...
	*/
	const NAME$43 = "alert";
	const EVENT_KEY$35 = `.coreui.alert`;
	...
	*/
	...
	const EVENT_KEY$34 = `.coreui.focustrap`;
	...
	*/
	const NAME$41 = "popup";
	const EVENT_KEY$33 = `.coreui.popup`;
	...
	*/
	...
	const DATA_KEY$3 = "coreui.autocomplete";
	...
	const SELECTOR_DATA_TOGGLE$24 = "[data-coreui-toggle=\"autocomplete\"]:not(.disabled)";
	...
	*/
	...
	const EVENT_KEY$31 = `.coreui.button`;
	const DATA_API_KEY$28 = ".data-api";
	const CLASS_NAME_ACTIVE$8 = "active";
	const SELECTOR_DATA_TOGGLE$23 = "[data-coreui-toggle=\"button\"]";
	...
	*/
	...
	const EVENT_KEY$30 = `.coreui.calendar`;
	...
	const SELECTOR_DATA_TOGGLE$22 = "[data-coreui-toggle=\"calendar\"]";
	const Default$38 = {
	...
	*/
	...
	const EVENT_KEY$29 = `.coreui.carousel`;
	...
	*/
	const NAME$36 = "chip";
	const EVENT_KEY$28 = `.coreui.chip`;
	...
	*/
	...
	const EVENT_KEY$27 = `.coreui.chip-set`;
	...
	*/
	...
	const EVENT_KEY$26 = `.coreui.chip-input`;
	...
	var ChipInput = class extends ChipSet {
		...
		_handleInputKeydown(event) {
			...
			switch (key) {
				...
				case "ArrowLeft":
				case "ArrowRight":
					if (key === (isRTL() ? "ArrowRight" : "ArrowLeft") && this._input.selectionStart === 0 && this._input.selectionEnd === 0) {
						event.preventDefault();
						const chips = this._getChipElements();
						if (chips.length > 0) chips[chips.length - 1].focus();
					}
	...
	*/
	...
	const EVENT_KEY$25 = `.coreui.collapse`;
	...
	const SELECTOR_DATA_TOGGLE$21 = "[data-coreui-toggle=\"collapse\"]";
	...
	*/
	...
	const EVENT_KEY$24 = `.coreui.date-picker`;
	...
	const SELECTOR_DATA_TOGGLE$20 = "[data-coreui-toggle=\"date-picker\"]";
	const SELECTOR_TEMPLATE_FOOTER$3 = "template[data-coreui-template=\"footer\"]";
	const SELECTOR_ACTION$3 = "[data-coreui-picker-action]";
	...
	var DatePicker = class extends BaseComponent {
		...
		_addEventListeners() {
			...
			EventHandler.on(this._menu, EVENT_CLICK$8, SELECTOR_ACTION$3, (event) => {
				const action = event.target.closest(SELECTOR_ACTION$3).dataset.coreuiPickerAction;
	...
	*/
	...
	const EVENT_KEY$23 = `.coreui.date-range-picker`;
	...
	const SELECTOR_DATA_TOGGLE$19 = "[data-coreui-toggle=\"date-range-picker\"]";
	const SELECTOR_TEMPLATE_FOOTER$2 = "template[data-coreui-template=\"footer\"]";
	const SELECTOR_TEMPLATE_RANGES = "template[data-coreui-template=\"ranges\"]";
	const SELECTOR_ACTION$2 = "[data-coreui-picker-action]";
	const Default$29 = {
		allowList: SVGAllowlist,
		ariaCleanerLabel: "Clear the value",
	...
	var DateRangePicker = class extends BaseComponent {
		...
		_addEventListeners() {
			...
			EventHandler.on(this._menu, EVENT_CLICK$7, SELECTOR_ACTION$2, (event) => {
				const action = event.target.closest(SELECTOR_ACTION$2).dataset.coreuiPickerAction;
				const context = this.getContext();
				if (typeof context[action] === "function") context[action]();
			});
		}
	...
	*/
	...
	const EVENT_LOAD_DATA_API$14 = `load.coreui.date-time-input.data-api`;
		...
		_addRollKeyboardNavigation() {
			...
			EventHandler.on(this._element, EVENT_KEYDOWN$5, SELECTOR_ROLL_CELL, (event) => {
				...
				if (event.key === ARROW_LEFT_KEY$4 || event.key === ARROW_RIGHT_KEY$4) {
					event.preventDefault();
					const goLeft = event.key === ARROW_LEFT_KEY$4 && !isRTL() || event.key === ARROW_RIGHT_KEY$4 && isRTL();
	...
	*/
	...
	const EVENT_KEY$22 = `.coreui.date-time-picker`;
	...
	const SELECTOR_DATA_TOGGLE$18 = "[data-coreui-toggle=\"date-time-picker\"]";
	const SELECTOR_TEMPLATE_FOOTER$1 = "template[data-coreui-template=\"footer\"]";
	const Default$26 = {
		allowList: SVGAllowlist,
		ariaCleanerLabel: "Clear the value",
		ariaToggleLabel: "Toggle the calendar",
	...
	*/
	...
	const EVENT_KEY$21 = `.coreui.dialog`;
	...
	const SELECTOR_DATA_TOGGLE$17 = "[data-coreui-toggle=\"dialog\"]";
	const Default$25 = {
		backdrop: true,
		keyboard: true,
		modal: true
	...
	*/
	...
	const EVENT_KEY$20 = `.coreui.drawer`;
	...
	const SELECTOR_DATA_TOGGLE$16 = "[data-coreui-toggle=\"drawer\"]";
	...
	*/
	const NAME$24 = "menu";
	const EVENT_KEY$19 = `.coreui.menu`;
	...
	*/
	var Menu = class Menu extends BaseComponent {
		...
		_getConfig(config) {
			...
			if (typeof config.reference === "object" && !isElement(config.reference) && typeof config.reference.getBoundingClientRect !== "function") throw new TypeError(`${NAME$24.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
			return config;
		}
		_createFloating() {
	...
	*/
	...
	const EVENT_KEY$18 = `.coreui.dropdown`;
	...
	*/
	...
	const DATA_KEY$2 = "coreui.loading-button";
	...
	const SELECTOR_DATA_TOGGLE$15 = "[data-coreui-toggle=\"loading-button\"]";
	const Default$21 = {
	...
	*/
	const NAME$21 = "modal";
	const EVENT_KEY$16 = `.coreui.modal`;
	...
	const SELECTOR_DATA_TOGGLE$14 = "[data-coreui-toggle=\"modal\"]";
	const Default$20 = {
		backdrop: true,
		keyboard: true,
		modal: true
	...
	*/
	...
	const DATA_KEY$1 = "coreui.multi-select";
	...
	*/
	...
	const EVENT_KEY$13 = `.coreui.offcanvas`;
	...
	const SELECTOR_DATA_TOGGLE$13 = "[data-coreui-toggle=\"offcanvas\"]";
	...
	*/
	...
	const EVENT_KEY$12 = `.coreui.otp-input`;
	...
	const SELECTOR_DATA_TOGGLE$12 = "[data-coreui-toggle=\"otp\"]";
	const Default$16 = {
	...
	*/
	...
	const EVENT_KEY$11 = `.coreui.number-input`;
	...
	const SELECTOR_DATA_TOGGLE$11 = "[data-coreui-toggle=\"number-input\"]";
	...
	*/
	...
	const EVENT_KEY$10 = `.coreui.password-input`;
	const DATA_API_KEY$7 = ".data-api";
	const CLASS_NAME_ACTION = "form-control-action";
	const CLASS_NAME_PASSWORD_INPUT = "password-input";
	const SELECTOR_DATA_TOGGLE$10 = "[data-coreui-toggle=\"password-input\"]";
	const Default$14 = {
		allowList: SVGAllowlist,
	...
	*/
	...
	const EVENT_KEY$9 = `.coreui.password-strength`;
	...
	const SELECTOR_DATA_TOGGLE$9 = "[data-coreui-toggle=\"password-strength\"]";
	...
	*/
	...
	const SELECTOR_DATA_TOGGLE$8 = "[data-coreui-toggle=\"tooltip\"]";
	...
	*/
	...
	const SELECTOR_DATA_TOGGLE$7 = "[data-coreui-toggle=\"popover\"]";
	...
	*/
	...
	const EVENT_KEY$8 = `.coreui.range-slider`;
	...
	const SELECTOR_DATA_TOGGLE$6 = "[data-coreui-toggle=\"range-slider\"]";
	...
	var RangeSlider = class RangeSlider extends BaseComponent {
		...
		_createLabels() {
			...
			for (const [index, label] of this._config.labels.entries()) {
				...
				else labelElement.style[isRTL() ? "right" : "left"] = position;
		...
		_calculateHorizontalPosition(mouseX, rect) {
			if (mouseX < rect.left) return isRTL() ? "max" : "min";
			if (mouseX > rect.right) return isRTL() ? "min" : "max";
	...
	*/
	const NAME$9 = "rating";
	const EVENT_KEY$7 = `.coreui.rating`;
	...
	const SELECTOR_DATA_TOGGLE$5 = "[data-coreui-toggle=\"rating\"]";
	...
	*/
	...
	const EVENT_KEY$6 = `.coreui.scrollspy`;
	...
	*/
	...
	const EVENT_KEY$5 = `.coreui.search-button`;
	...
	const SELECTOR_DATA_TOGGLE$4 = "[data-coreui-search-button]";
	...
	*/
	...
	const EVENT_MOUSEDOWN = `mousedown.coreui.${NAME$6}`;
	const Default$5 = {
	...
	*/
	...
	const EVENT_KEY$4 = `.coreui.sidebar`;
	...
	const SELECTOR_DATA_TOGGLE$3 = "[data-coreui-toggle]";
	...
	*/
	...
	const EVENT_KEY$3 = `.coreui.stepper`;
	...
	const SELECTOR_DATA_TOGGLE$2 = "[data-coreui-toggle=\"stepper\"]";
	...
	*/
	...
	const SELECTOR_DATA_TOGGLE$1 = "[data-coreui-toggle=\"tab\"], [data-coreui-toggle=\"pill\"], [data-coreui-toggle=\"list\"]";
	...
	*/
	...
	const EVENT_KEY$1 = `.coreui.time-picker`;

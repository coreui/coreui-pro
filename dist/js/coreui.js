/*!
  * CoreUI v3.0.0-alpha.12 (https://coreui.io)
...
(function (global, factory) {
  ...
  * add .asyncLoad to jQuery only if jQuery is present
  ...
  /**
   * --------------------------------------------------------------------------
   * CoreUI (v3.0.0-alpha.12): index.umd.js
   * Licensed under MIT (https://coreui.io/license)
   * --------------------------------------------------------------------------
   */
  var index_umd = {

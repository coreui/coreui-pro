...
/**
 * --------------------------------------------------------------------------
 * CoreUI (v4.3.1): dom/event-handler.js
 * Licensed under MIT (https://coreui.io/license)
 *
...
/**
 * --------------------------------------------------------------------------
 * CoreUI (v4.3.1): dom/manipulator.js
 * Licensed under MIT (https://coreui.io/license)
 *
...
/**
 * --------------------------------------------------------------------------
 * CoreUI (v4.3.1): dom/selector-engine.js
 * Licensed under MIT (https://coreui.io/license)
 *

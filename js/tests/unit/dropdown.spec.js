...
describe('Dropdown', () => {
  ...
  describe('constructor', () => {
    ...
    it('should work on invalid markup', () => {
      return new Promise(resolve => {
        ...
        dropdownElem.addEventListener('shown.coreui.dropdown', () => {
          resolve()
        })
    ...
    it('should create offset modifier correctly when offset option is a string into data attribute', () => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" data-coreui-offset="10,20">Dropdown</button>',
        '  <div class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Secondary link</a>',
        '  </div>',
        '</div>'
  ...
  describe('toggle', () => {
    ...
    it('should toggle a dropdown with a valid virtual element reference', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="dropdown">',
          '  <button class="btn dropdown-toggle visually-hidden" data-coreui-toggle="dropdown" aria-expanded="false">Dropdown</button>',
          '  <div class="dropdown-menu">',
          '    <a class="dropdown-item" href="#">Secondary link</a>',
          '  </div>',
          '</div>'
    ...
    it('should not toggle a dropdown if the element is disabled', () => {
      return new Promise((resolve, reject) => {
        ...
        btnDropdown.addEventListener('shown.coreui.dropdown', () => {
          reject(new Error('should not throw shown.coreui.dropdown event'))
        })
  ...
  describe('hide', () => {
    it('should hide a dropdown', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="dropdown">',
          '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" aria-expanded="true">Dropdown</button>',
          '  <div class="dropdown-menu show">',
          '    <a class="dropdown-item" href="#">Secondary link</a>',
          '  </div>',
          '</div>'
    ...
    it('should not hide a dropdown if the element is disabled', () => {
      return new Promise((resolve, reject) => {
        ...
        btnDropdown.addEventListener('hidden.coreui.dropdown', () => {
          reject(new Error('should not throw hidden.coreui.dropdown event'))
        })
  ...
  describe('data-api', () => {
    it('should show and hide a dropdown', () => {
      return new Promise(resolve => {
        ...
        btnDropdown.addEventListener('show.coreui.dropdown', () => {
    ...
    it('should not use "static" Popper in navbar', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<nav class="navbar navbar-expand-md bg-4">',
          '  <div class="dropdown">',
          '    <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" aria-expanded="false">Dropdown</button>',
          '    <div class="dropdown-menu">',
          '      <a class="dropdown-item" href="#">Secondary link</a>',
    ...
    it('should manage bs attribute `data-coreui-popper`="static" when dropdown is in navbar', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<nav class="navbar navbar-expand-md bg-4">',
          '  <div class="dropdown">',
        ...
        btnDropdown.addEventListener('hidden.coreui.dropdown', () => {
          expect(dropdownMenu.getAttribute('data-coreui-popper')).toBeNull()
          resolve()
        })
    ...
    it('should manage bs attribute `data-coreui-popper`="static" when display set to static', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="dropdown">',
          '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" data-coreui-display="static">Dropdown</button>',
    ...
    it('should be able to identify clicked dropdown, even with multiple dropdowns in the same tag', () => {
      fixtureEl.innerHTML = [
        '<div class="dropdown">',
        '  <button id="dropdown1" class="btn dropdown-toggle" data-coreui-toggle="dropdown">Dropdown toggle</button>',
        '  <div id="menu1" class="dropdown-menu">',
        '    <a class="dropdown-item" href="#">Dropdown item</a>',
        '  </div>',
        '  <button id="dropdown2" class="btn dropdown-toggle" data-coreui-toggle="dropdown">Dropdown toggle</button>',
    ...
    it('should fire hide and hidden event without a clickEvent if event type is not click', () => {
      return new Promise(resolve => {
        ...
        triggerDropdown.addEventListener('shown.coreui.dropdown', () => {
    ...
    it('should bubble up the events to the parent elements', () => {
      return new Promise(resolve => {
        ...
        dropdownParent.addEventListener('show.coreui.dropdown', showFunction)

        const shownFunction = jasmine.createSpy('shownFunction')
        dropdownParent.addEventListener('shown.coreui.dropdown', () => {
          shownFunction()
          dropdown.hide()
        })

        const hideFunction = jasmine.createSpy('hideFunction')
        dropdownParent.addEventListener('hide.coreui.dropdown', hideFunction)

        dropdownParent.addEventListener('hidden.coreui.dropdown', () => {
    ...
    it('should close the dropdown if the user clicks on a text field that is not contained within dropdown-menu', () => {
      return new Promise(resolve => {
        ...
        triggerDropdown.addEventListener('hidden.coreui.dropdown', () => {
          expect().nothing()
          resolve()
        })
    ...
    it('should propagate escape key events if dropdown is closed', () => {
      return new Promise(resolve => {
        ...
        const toggle = fixtureEl.querySelector('[data-coreui-toggle="dropdown"]')
    ...
    it('should close dropdown using `escape` button, and return focus to its trigger', () => {
      return new Promise(resolve => {
        ...
        toggle.addEventListener('shown.coreui.dropdown', () => {
        ...
        toggle.addEventListener('hidden.coreui.dropdown', () => setTimeout(() => {
    ...
    it('should close dropdown (only) by clicking inside the dropdown menu when it has data-attribute `data-coreui-auto-close="inside"`', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="dropdown">',
          '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" data-coreui-auto-close="inside">Dropdown toggle</button>',
          '  <div class="dropdown-menu">',
          '    <a class="dropdown-item" href="#">Dropdown item</a>',
          ' </div>',
          '</div>'
        ...
        const dropdownToggle = fixtureEl.querySelector('[data-coreui-toggle="dropdown"]')
        const dropdownMenu = fixtureEl.querySelector('.dropdown-menu')
        ...
        dropdownToggle.addEventListener('shown.coreui.dropdown', () => {
          document.documentElement.click()
          expectDropdownToBeOpened()
        })

        dropdownToggle.addEventListener('hidden.coreui.dropdown', () => setTimeout(() => {
    ...
    it('should close dropdown (only) by clicking outside the dropdown menu when it has data-attribute `data-coreui-auto-close="outside"`', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="dropdown">',
          '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" data-coreui-auto-close="outside">Dropdown toggle</button>',
          '  <div class="dropdown-menu">',
          '    <a class="dropdown-item" href="#">Dropdown item</a>',
          ' </div>',
          '</div>'
        ...
        dropdownToggle.addEventListener('hidden.coreui.dropdown', () => {
          expect(dropdownToggle).not.toHaveClass('show')
          resolve()
        })
    ...
    it('should not close dropdown by clicking inside or outside the dropdown menu when it has data-attribute `data-coreui-auto-close="false"`', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div class="dropdown">',
          '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown" data-coreui-auto-close="false">Dropdown toggle</button>',
          '  <div class="dropdown-menu">',
          '    <a class="dropdown-item" href="#">Dropdown item</a>',
          ' </div>',
          '</div>'
    ...
    it('should be able to identify clicked dropdown, no matter the markup order', () => {
      fixtureEl.innerHTML = [
        ...
        '    <a class="dropdown-item" href="#">Dropdown item</a>',
        '  </div>',
        '  <button class="btn dropdown-toggle" data-coreui-toggle="dropdown">Dropdown toggle</button>',
        '</div>'
      ].join('')
  ...
  it('should open dropdown when pressing keydown or keyup', () => {
    return new Promise(resolve => {
      ...
      dropdown.addEventListener('shown.coreui.dropdown', event => {
  ...
  it('should open the dropdown when clicking the child element inside `data-coreui-toggle="dropdown"`', () => {
    return new Promise(resolve => {
      fixtureEl.innerHTML = [
        '<div class="container">',
        '  <div class="dropdown">',

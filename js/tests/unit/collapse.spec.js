...
describe('Collapse', () => {
  ...
  describe('DATA_KEY', () => {
    it('should return plugin data key', () => {
      expect(Collapse.DATA_KEY).toEqual('coreui.collapse')
    })
  })
  ...
  describe('toggle', () => {
    ...
    it('should find collapse children if they have collapse class too not only data-coreui-parent', () => {
  ...
  describe('hide', () => {
    ...
    it('should not fire hidden when hide is prevented', () => {
      return new Promise((resolve, reject) => {
        ...
        collapseEl.addEventListener('hide.coreui.collapse', event => {
          event.preventDefault()
          expectEnd()
        })
  ...
  describe('data-api', () => {
    it('should prevent url change if click on nested elements', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<a role="button" data-coreui-toggle="collapse" class="collapsed" href="#collapse">',
          '  <span id="nested"></span>',
          '</a>',
    ...
    it('should set aria-expanded on triggers only when all the targeted collapse are hidden', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '<a id="trigger2" role="button" data-coreui-toggle="collapse" href="#0/my/id"></a>',

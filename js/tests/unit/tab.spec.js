...
describe('Tab', () => {
  ...
  describe('show', () => {
    ...
    it('should activate element by tab id in nav list', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<nav class="nav">',
          '  <button type="button" data-coreui-target="#home" role="tab">Home</button>',
          '  <button type="button" id="triggerProfile" data-coreui-target="#profile" role="tab">Profile</button>',
          '</nav>',
          '<div>',
    ...
    it('should not fire shown when tab is already active', () => {
      return new Promise((resolve, reject) => {
        fixtureEl.innerHTML = [
          ...
          '  <li class="nav-item" role="presentation"><button type="button" data-coreui-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" data-coreui-target="#profile" class="nav-link" role="tab">Profile</button></li>',
          '</ul>',
    ...
    it('show and shown events should reference correct relatedTarget', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" data-coreui-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" id="triggerProfile" data-coreui-target="#profile" class="nav-link" role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
          '  <div class="tab-pane active" id="home" role="tabpanel"></div>',
          '  <div class="tab-pane" id="profile" role="tabpanel"></div>',
        ...
        secondTabTrigger.addEventListener('show.coreui.tab', ev => {
          expect(ev.relatedTarget.getAttribute('data-coreui-target')).toEqual('#home')
        })
    ...
    it('should fire hide and hidden events', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav" role="tablist">',
          '  <li><button type="button" data-coreui-target="#home" role="tab">Home</button></li>',
          '  <li><button type="button" data-coreui-target="#profile" role="tab">Profile</button></li>',
          '</ul>'
        ].join('')
        ...
        triggerList[0].addEventListener('hide.coreui.tab', ev => {
          hideCalled = true
          expect(ev.relatedTarget.getAttribute('data-coreui-target')).toEqual('#profile')
        })
    ...
    it('should not focus on opened tab', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav" role="tablist">',
          '  <li><button type="button" id="home" data-coreui-target="#home" role="tab">Home</button></li>',
          '  <li><button type="button" id="triggerProfile" data-coreui-target="#profile" role="tab">Profile</button></li>',
          '</ul>',
          '<ul>',
          '  <li id="home" role="tabpanel"></li>',
  ...
  describe('_setInitialAttributes', () => {
    it('should put aria attributes', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav">',
        '  <li class="nav-link" id="foo" data-coreui-target="#panel"></li>',
        '  <li class="nav-link" data-coreui-target="#panel2"></li>',
        '</ul>',
        '<div id="panel"></div>',
        '<div id="panel2"></div>'
      ].join('')
  ...
  describe('_keydown', () => {
    it('if event is not one of left/right/up/down arrow, ignore it', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav">',
        '  <li class="nav-link" data-coreui-toggle="tab"></li>',
        '</ul>'
      ].join('')
    ...
    it('if keydown event is right arrow and next element is disabled', () => {
      fixtureEl.innerHTML = [
        '<div class="nav">',
        '  <span id="tab1" class="nav-link" data-coreui-toggle="tab"></span>',
        '  <span id="tab2" class="nav-link" data-coreui-toggle="tab" disabled></span>',
        '  <span id="tab3" class="nav-link disabled" data-coreui-toggle="tab"></span>',
        '  <span id="tab4" class="nav-link" data-coreui-toggle="tab"></span>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    it('should create dynamically a tab', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" data-coreui-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" id="triggerProfile" data-coreui-toggle="tab" data-coreui-target="#profile" class="nav-link" role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
          '  <div class="tab-pane active" id="home" role="tabpanel"></div>',
          '  <div class="tab-pane" id="profile" role="tabpanel"></div>',
    ...
    it('selecting a dropdown tab does not activate another', () => {
      const nav1 = [
        ...
        '  <li class="nav-item active"><a class="nav-link" href="#home" data-coreui-toggle="tab">Home</a></li>',
        '  <li class="nav-item dropdown">',
    ...
    it('should support li > .dropdown-item', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs">',
        '  <li class="nav-item"><a class="nav-link active" href="#home" data-coreui-toggle="tab">Home</a></li>',
        '  <li class="nav-item"><a class="nav-link" href="#profile" data-coreui-toggle="tab">Profile</a></li>',
        '  <li class="nav-item dropdown">',
        '    <a class="nav-link dropdown-toggle" data-coreui-toggle="dropdown" href="#">Dropdown</a>',
        '    <ul class="dropdown-menu">',
        '      <li><a class="dropdown-item" href="#dropdown1" id="dropdown1-tab" data-coreui-toggle="tab">@fat</a></li>',
        '      <li><a class="dropdown-item" href="#dropdown2" id="dropdown2-tab" data-coreui-toggle="tab">@mdo</a></li>',
        '    </ul>',
        '  </li>',
        '</ul>'
      ].join('')
    ...
    it('should handle nested tabs', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  <button type="button" id="tab1" data-coreui-target="#x-tab1" class="nav-link" data-coreui-toggle="tab" role="tab" aria-controls="x-tab1">Tab 1</button>',
          '  <button type="button" data-coreui-target="#x-tab2" class="nav-link active" data-coreui-toggle="tab" role="tab" aria-controls="x-tab2" aria-selected="true">Tab 2</button>',
          '  <button type="button" data-coreui-target="#x-tab3" class="nav-link" data-coreui-toggle="tab" role="tab" aria-controls="x-tab3">Tab 3</button>',
          '</nav>',
          '<div class="tab-content">',
          '  <div class="tab-pane" id="x-tab1" role="tabpanel">',
          '    <nav class="nav nav-tabs" role="tablist">',
          '      <button type="button" data-coreui-target="#nested-tab1" class="nav-link active" data-coreui-toggle="tab" role="tab" aria-controls="x-tab1" aria-selected="true">Nested Tab 1</button>',
          '      <button type="button" id="tabNested2" data-coreui-target="#nested-tab2" class="nav-link" data-coreui-toggle="tab" role="tab" aria-controls="x-profile">Nested Tab2</button>',
          '    </nav>',
          '    <div class="tab-content">',
    ...
    it('should not remove fade class if no active pane is present', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" id="tab-home" data-coreui-target="#home" class="nav-link" data-coreui-toggle="tab" role="tab">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" id="tab-profile" data-coreui-target="#profile" class="nav-link" data-coreui-toggle="tab" role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
    ...
    it('should add `show` class to tab panes if there is no `.fade` class', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation">',
          '    <button type="button" class="nav-link nav-tab" data-coreui-target="#home" role="tab" data-coreui-toggle="tab">Home</button>',
          '  </li>',
          '  <li class="nav-item" role="presentation">',
          '    <button type="button" id="secondNav" class="nav-link nav-tab" data-coreui-target="#profile" role="tab" data-coreui-toggle="tab">Profile</button>',
          '  </li>',
          '</ul>',
          '<div class="tab-content">',
    ...
    it('should prevent default when the trigger is <a> or <area>', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<ul class="nav" role="tablist">',
          '  <li><a type="button" href="#test"  class="active" role="tab" data-coreui-toggle="tab">Home</a></li>',
          '  <li><a type="button" href="#test2" role="tab" data-coreui-toggle="tab">Home</a></li>',
          '</ul>'
        ].join('')
        ...
        tabEl.addEventListener('shown.coreui.tab', () => {
    ...
    it('should not fire shown when tab has disabled attribute', () => {
      return new Promise((resolve, reject) => {
        fixtureEl.innerHTML = [
          '<ul class="nav nav-tabs" role="tablist">',
          '  <li class="nav-item" role="presentation"><button type="button" data-coreui-target="#home" class="nav-link active" role="tab" aria-selected="true">Home</button></li>',
          '  <li class="nav-item" role="presentation"><button type="button" data-coreui-target="#profile" class="nav-link" disabled role="tab">Profile</button></li>',
          '</ul>',
          '<div class="tab-content">',
          '  <div class="tab-pane active" id="home" role="tabpanel"></div>',
          '  <div class="tab-pane" id="profile" role="tabpanel"></div>',

...
describe('Button', () => {
  ...
  describe('DATA_KEY', () => {
    it('should return plugin data key', () => {
      expect(Button.DATA_KEY).toEqual('coreui.button')
    })
  })
  ...
  describe('data-api', () => {
    it('should toggle active class on click', () => {
      fixtureEl.innerHTML = [
        ...
        '<button class="btn testParent" data-coreui-toggle="button"><div class="test"></div></button>'
      ].join('')
  ...
  describe('toggle', () => {
    it('should toggle aria-pressed', () => {
      fixtureEl.innerHTML = '<button class="btn" data-coreui-toggle="button" aria-pressed="false"></button>'

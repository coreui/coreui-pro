...
describe('Carousel', () => {
  ...
  describe('constructor', () => {
    ...
    it('should start cycling if `ride`===`carousel`', () => {
      fixtureEl.innerHTML = '<div id="myCarousel" class="carousel slide" data-coreui-ride="carousel"></div>'
    ...
    it('should not start cycling if `ride`!==`carousel`', () => {
      fixtureEl.innerHTML = '<div id="myCarousel" class="carousel slide" data-coreui-ride="true"></div>'
    ...
    it('should ignore keyboard events if data-coreui-keyboard=false', () => {
      fixtureEl.innerHTML = [
        '<div id="myCarousel" class="carousel slide" data-coreui-keyboard="false">',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active">item 1</div>',
        '    <div id="item2" class="carousel-item">item 2</div>',
        '  </div>',
      ...
      expect(spy).not.toHaveBeenCalledWith(carouselEl, 'keydown.coreui.carousel', jasmine.any(Function))
    })

    it('should ignore mouse events if data-coreui-pause=false', () => {
      fixtureEl.innerHTML = [
        '<div id="myCarousel" class="carousel slide" data-coreui-pause="false">',
        '  <div class="carousel-inner">',
        '    <div class="carousel-item active">item 1</div>',
        '    <div id="item2" class="carousel-item">item 2</div>',
        '  </div>',
      ...
      // eslint-disable-next-line no-new
      new Carousel('#myCarousel')
      expect(spy).not.toHaveBeenCalledWith(carouselEl, 'hover.coreui.carousel', jasmine.any(Function))
    })
    ...
    it('should call `maybeEnableCycle` on mouse out with pause equal to hover', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<div class="carousel" data-coreui-ride="true"></div>'
  ...
  describe('next', () => {
    ...
    it('should update indicators if present', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <button type="button" id="firstIndicator" data-coreui-target="myCarousel" data-coreui-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>',
          '    <button type="button" id="secondIndicator" data-coreui-target="myCarousel" data-coreui-slide-to="1" aria-label="Slide 2"></button>',
          '    <button type="button" data-coreui-target="myCarousel" data-coreui-slide-to="2" aria-label="Slide 3"></button>',
          '  </div>',
          '  <div class="carousel-inner">',
          '    <div class="carousel-item active">item 1</div>',
    ...
    it('should call next()/prev() instance methods when clicking the respective direction buttons', () => {
      fixtureEl.innerHTML = [
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <button class="carousel-control-prev" type="button" data-coreui-target="#carousel" data-coreui-slide="prev"></button>',
        '  <button class="carousel-control-next" type="button" data-coreui-target="#carousel" data-coreui-slide="next"></button>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    ...
    it('should create carousel and go to the next slide on click (with real button controls)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <div class="carousel-item">item 3</div>',
          '  </div>',
          '  <button class="carousel-control-prev" data-coreui-target="#myCarousel" type="button" data-coreui-slide="prev"></button>',
          '  <button id="next" class="carousel-control-next" data-coreui-target="#myCarousel" type="button" data-coreui-slide="next"></button>',
          '</div>'
        ].join('')
    ...
    it('should create carousel and go to the next slide on click (using links as controls)', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '    <div class="carousel-item">item 3</div>',
          '  </div>',
          '  <a class="carousel-control-prev" href="#myCarousel" role="button" data-coreui-slide="prev"></a>',
          '  <a id="next" class="carousel-control-next" href="#myCarousel" role="button" data-coreui-slide="next"></a>',
          '</div>'
        ].join('')
    ...
    it('should create carousel and go to the next slide on click with data-coreui-slide-to', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          '<div id="myCarousel" class="carousel slide" data-coreui-ride="true">',
          '  <div class="carousel-inner">',
          '    <div class="carousel-item active">item 1</div>',
          '    <div id="item2" class="carousel-item">item 2</div>',
          '    <div class="carousel-item">item 3</div>',
    ...
    it('should do nothing if no selector on click on arrows', () => {
      fixtureEl.innerHTML = [
        ...
        '  </div>',
        '  <button class="carousel-control-prev" data-coreui-target="#myCarousel" type="button" data-coreui-slide="prev"></button>',
        '  <button id="next" class="carousel-control-next" type="button" data-coreui-slide="next"></button>',
        '</div>'
      ].join('')

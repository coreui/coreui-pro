...
describe('Util', () => {
  ...
  describe('getjQuery', () => {
    ...
    it('should not return jQuery object when present if data-coreui-no-jquery', () => {
      document.body.setAttribute('data-coreui-no-jquery', '')

      expect(window.jQuery).toEqual(fakejQuery)
      expect(Util.getjQuery()).toBeNull()

      document.body.removeAttribute('data-coreui-no-jquery')
    })

...
describe('Transfer', () => {
  ...
  const setMarkup = (attrs = '', source = ['one', 'two', 'three'], target = ['four'], search = false) => {
    ...
    fixtureEl.innerHTML = [
      ...
      '<button type="button" class="btn btn-outline-secondary btn-sm" data-coreui-transfer-move="target-all"></button>',
      '<button type="button" class="btn btn-outline-secondary btn-sm" data-coreui-transfer-move="target"></button>',
      '<button type="button" class="btn btn-outline-secondary btn-sm" data-coreui-transfer-move="source"></button>',
      '<button type="button" class="btn btn-outline-secondary btn-sm" data-coreui-transfer-move="source-all"></button>',
      '</div>',

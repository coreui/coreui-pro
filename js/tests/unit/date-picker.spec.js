...
describe('DatePicker', () => {
  ...
  const pickMinutes = (value, scope = fixtureEl) => {
    const select = scope.querySelector('select.date-picker-time-select.minutes')
  ...
  describe('constructor', () => {
    it('should carry a global default override to the field and the calendar', () => {
      ...
      try {
        ...
        expect(fixtureEl.querySelector('.date-picker-popup .calendar-cell-inner.month')).not.toBeNull()
      } finally {
  ...
  describe('jQueryInterface', () => {
    ...
    it('should pass the arguments to the method', () => {
      ...
      const instance = DatePicker.getOrCreateInstance(el)
      const spy = spyOn(instance, 'setDate')

      jQueryMock.fn.datePicker.call(jQueryMock, 'setDate', new Date(2027, 0, 15))
  ...
  describe('timepicker', () => {
    ...
    it('should keep the time selects to a single tab stop and move between them with the arrows', () => {
      ...
      const selects = [...body.querySelectorAll('select.date-picker-time-select')]

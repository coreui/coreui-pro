/*!
  * CoreUI navigation.js v4.3.0-beta.1 (https://coreui.io)
...
(function (global, factory) {
  ...
  /**
   * --------------------------------------------------------------------------
   * CoreUI (v4.3.0-beta.1): navigation.js
  ...
  class Navigation extends BaseComponent__default.default {
    ...
    _toggleGroupItems(event) {
      ...
      const filter = element => Boolean(element.classList.contains(CLASS_NAME_NAV_GROUP) && element.classList.contains(CLASS_NAME_SHOW)); // Close other groups
  ...
  index.defineJQueryPlugin(Navigation);

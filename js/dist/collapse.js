/*!
  * CoreUI collapse.js v4.0.0-rc.6 (https://coreui.io)
...
(function (global, factory) {
  ...
  class Collapse extends BaseComponent__default['default'] {
    constructor(element, config) {
      ...
      this._triggerArray = SelectorEngine__default['default'].find(`${SELECTOR_DATA_TOGGLE}[href="#${this._element.id}"],` + `${SELECTOR_DATA_TOGGLE}[data-coreui-target="#${this._element.id}"]`);

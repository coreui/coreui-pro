/*!
  * CoreUI sidebar.js v4.3.0-beta.1 (https://coreui.io)
  * Copyright 2022 The CoreUI Team (https://github.com/orgs/coreui/people)
  * Licensed under MIT (https://coreui.io)
  */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('./util/index'), require('./util/scrollbar'), require('./dom/event-handler'), require('./base-component'), require('./dom/manipulator'), require('./util/backdrop')) :
...
})(this, (function (index, ScrollBarHelper, EventHandler, BaseComponent, Manipulator, Backdrop) { 'use strict';
  ...
  /**
   * --------------------------------------------------------------------------
   * CoreUI (v4.3.0-beta.1): sidebar.js
  ...
  index.defineJQueryPlugin(Sidebar);

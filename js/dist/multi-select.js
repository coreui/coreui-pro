/*!
  * CoreUI multi-select.js v5.25.1 (https://coreui.io)
...
(function (global, factory) {
  ...
  class MultiSelect extends BaseComponent {
    ...
    _maybeSanitize(content) {
      return this._config.sanitize ? sanitizer_js.sanitizeHtml(content, this._config.allowList, this._config.sanitizeFn) : content;
    }
    ...
    _toggleGroup(optgroupEl) {
      ...
      const items = SelectorEngine.children(optgroupEl, SELECTOR_OPTION).filter(element => !element.classList.contains(CLASS_NAME_DISABLED));

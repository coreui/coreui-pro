...
export function buildProject(data: ExampleData, target: SandboxTarget = 'stackblitz') {
  // Pro components scaffold against @coreui/coreui-pro; free components against the free
  // @coreui/coreui so a free user can run the sandbox. `pro` is set per example by the page.

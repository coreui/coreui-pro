---
title: "Bootstrap 5 Grid System (Container Query Version)"
name: "Grid system (Container Query version)"
...
<ScssDocs file="scss/_config.scss" capture="cq-grid-breakpoints" />

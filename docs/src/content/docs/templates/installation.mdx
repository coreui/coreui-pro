...
CoreUI Bootstrap Admin Templates uses [npm scripts](https://docs.npmjs.com/misc/scripts/) for its build system. Our [package.json](https://github.com/coreui/coreui/blob/v5.8.0/package.json) includes convenient methods for working with the framework, including compiling code, running tests, and more.
...
2. [Download CoreUI Admin Template](/templates/download/) or [Download CoreUI PRO Admin Template](https://coreui.io/download/).

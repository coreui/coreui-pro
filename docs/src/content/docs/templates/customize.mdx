...
You will find the complete list of CoreUI's variables in `node_modules/@coreui/coreui/scss/_config.scss` or `node_modules/@coreui/coreui-pro/scss/_config.scss` if you use CoreUI PRO. Some variables are set to `null`, these variables don't output the property unless they are overridden in your configuration. You can also find a specific component variables list in **Customizing** section ex. [Alerts - Customizing](/components/alerts/#customizing)

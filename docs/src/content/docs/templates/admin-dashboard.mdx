...
<div class="row">
  <div class="col-md-6">
    <div class="card mb-4">
      <div class="card-body">
        <a class="text-decoration-none fg-reset" href="https://coreui.io/product/free-bootstrap-admin-template/" target="_blank">
          <h5 class="card-title">Free Bootstrap Admin Template</h5>
          <h6 class="card-subtitle mb-3 fg-2">Default Theme</h6>
  ...
  <div class="col-md-6">
    <div class="card mb-4">
      <div class="card-body">
        <a class="text-decoration-none fg-reset" href="https://coreui.io/product/bootstrap-dashboard-template/?theme=default-v3" target="_blank">
          <h5 class="card-title">Bootstrap Dashboard Template</h5>
          <h6 class="card-subtitle mb-3 fg-2">Default Theme v3</h6>
  ...
  <div class="col-md-6">
    <div class="card mb-4">
      <div class="card-body">
        <a class="text-decoration-none fg-reset" href="https://coreui.io/product/bootstrap-dashboard-template/?theme=light-v3" target="_blank">
          <h5 class="card-title">Bootstrap Dashboard Template</h5>
          <h6 class="card-subtitle mb-3 fg-2">Light Theme v3</h6>
  ...
  <div class="col-md-6">
    <div class="card mb-4">
      <div class="card-body">
        <a class="text-decoration-none fg-reset" href="https://coreui.io/product/bootstrap-dashboard-template/?theme=default" target="_blank">
          <h5 class="card-title">Bootstrap Dashboard Template</h5>
          <h6 class="card-subtitle mb-3 fg-2">Default Theme</h6>
  ...
  <div class="col-md-6">
    <div class="card mb-4">
      <div class="card-body">
        <a class="text-decoration-none fg-reset" href="https://coreui.io/product/bootstrap-dashboard-template/?theme=light" target="_blank">
          <h5 class="card-title">Bootstrap Dashboard Template</h5>
          <h6 class="card-subtitle mb-3 fg-2">Light Theme</h6>
  ...
  <div class="col-md-6">
    <div class="card mb-4">
      <div class="card-body">
        <a class="text-decoration-none fg-reset" href="https://coreui.io/product/bootstrap-dashboard-template/?theme=dark" target="_blank">
          <h5 class="card-title">Bootstrap Dashboard Template</h5>
          <h6 class="card-subtitle mb-3 fg-2">Dark Theme</h6>

...
CoreUI for Bootstrap sets basic global display, typography, and link styles. When more control is needed, check out the [textual utility classes](/utilities/text/).
...
Change text alignment, transform, style, weight, line-height, decoration and color with our [text utilities](/utilities/text/) and [color utilities](/utilities/colors/).

...
<ScssDocs file="scss/_variables.scss" capture="display-headings" />
...
<ScssDocs file="scss/_variables.scss" capture="headings-variables" />

Miscellaneous typography elements covered here and in [Reboot](/content/reboot/) also have dedicated variables.

<ScssDocs file="scss/_variables.scss" capture="type-variables" />

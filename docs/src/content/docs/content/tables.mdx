...
<ScssDocs file="scss/_tables.scss" capture="table-variant" />
...
<ScssDocs file="scss/_tables.scss" capture="table-variables" />

### SASS loop

<ScssDocs file="scss/_tables.scss" capture="table-loop" />

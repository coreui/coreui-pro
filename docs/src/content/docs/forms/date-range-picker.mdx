...
import dateRangePickerDisabledDates2 from './snippets/date-range-picker-disabled-dates2.js?raw'
import dateRangePickerCustomRanges from './snippets/date-range-picker-custom-ranges.js?raw'
import dateRangePickerCustomFormats1 from './snippets/date-range-picker-custom-formats1.js?raw'
import dateRangePickerCustomFormats2 from './snippets/date-range-picker-custom-formats2.js?raw'
...
<Example pro code={`<div class="row">
  ...
  </div>`} sandboxJs={dateRangePickerDisabledDates2} />

<Code code={dateRangePickerDisabledDates2} lang="js" />
...
<Example pro code={`<div class="row">
  ...
  </div>`} sandboxJs={dateRangePickerCustomRanges} />

<Code code={dateRangePickerCustomRanges} lang="js" />
...
<Example pro code={`<div class="row">
  ...
  </div>`} sandboxJs={dateRangePickerCustomFormats1} />
...
<Code code={dateRangePickerCustomFormats1} lang="js" />
...
<Example pro code={`<div class="row">
  ...
  </div>`} sandboxJs={dateRangePickerCustomFormats2} />
...
<Code code={dateRangePickerCustomFormats2} lang="js" />

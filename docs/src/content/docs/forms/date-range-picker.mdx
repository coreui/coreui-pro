...
<Example pro code={`<div data-coreui-locale="en-US" data-coreui-start-floating-label="Check-in" data-coreui-end-floating-label="Check-out" data-coreui-toggle="date-range-picker"></div>`} />

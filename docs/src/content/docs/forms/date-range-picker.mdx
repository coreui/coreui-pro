...
<Example pro lang="html" name="forms-date-range-picker-1" componentName="Date Range Picker" code={`  <div class="row">
...
<Example pro lang="html" name="forms-date-range-picker-2" componentName="Date Range Picker" code={`  <div class="row">
...
<Example pro lang="html" name="forms-date-range-picker-3" componentName="Date Range Picker" code={`  <div class="row">
      <div class="col-sm-6 mb-3 mb-sm-0">
        <div
...
<Example pro lang="html" name="forms-date-range-picker-4" componentName="Date Range Picker" code={`  <div class="row">
      <div class="col-sm-6 mb-3 mb-sm-0">
        <div 
          data-coreui-locale="en-US"
          data-coreui-toggle="date-range-picker"
...
<Example pro lang="html" name="forms-date-range-picker-5" componentName="Date Range Picker" code={`  <div class="row">
      <div class="col-sm-6 mb-3 mb-sm-0">
        <div 
          data-coreui-locale="en-US"
          data-coreui-toggle="date-range-picker"
...
<Example pro lang="html" name="forms-date-range-picker-6" componentName="Date Range Picker" code={`  <div class="row">
      <div class="col-sm-6 mb-3 mb-sm-0">
        <div 
          data-coreui-locale="en-US"
          data-coreui-toggle="date-range-picker"
...
<Example pro lang="html" name="forms-date-range-picker-7" componentName="Date Range Picker" code={`  <div class="row">
      <div class="col-sm-6 mb-3 mb-sm-0">
        <div
          data-coreui-locale="en-US"
          data-coreui-toggle="date-range-picker"
...
<Example pro lang="html" name="forms-date-range-picker-8" componentName="Date Range Picker" code={`<div class="row">
...
<Example pro lang="html" name="forms-date-range-picker-9" componentName="Date Range Picker" code={`<div class="row">
    <div class="col-sm-6">
...
<Example pro lang="html" name="forms-date-range-picker-10" componentName="Date Range Picker" code={`<div class="row">
    <div class="col-sm-6">
...
<Example pro lang="html" name="forms-date-range-picker-11" componentName="Date Range Picker" code={`  <div class="row">
      <div class="col-sm-6 mb-3 mb-sm-0">
...
<Example pro lang="html" name="forms-date-range-picker-14" componentName="Date Range Picker" code={`<div class="row">
    <div class="col-sm-6">
      <div id="myDateRangePickerCustomRanges"></div>
    </div>
  </div>`} sandboxJs={[`const myDateRangePickerCustomRanges = document.getElementById('myDateRangePickerCustomRanges')`, ``, `const optionsCustomRanges = {`, `  locale: 'en-US',`, `  ranges: {`, `    Today: [new Date(), new Date()],`, `    Yesterday: [`, `      new Date(new Date().setDate(new Date().getDate() - 1)),`, `      new Date(new Date().setDate(new Date().getDate() - 1))`, `    ],`, `    'Last 7 Days': [`, `      new Date(new Date().setDate(new Date().getDate() - 6)),`, `      new Date(new Date())`, `    ],`, `    'Last 30 Days': [`, `      new Date(new Date().setDate(new Date().getDate() - 29)),`, `      new Date(new Date())`, `    ],`, `    'This Month': [`, `      new Date(new Date().setDate(1)),`, `      new Date(new Date().getFullYear(), new Date().getMonth() + 1, 0)`, `    ],`, `    'Last Month': [`, `      new Date(new Date().getFullYear(), new Date().getMonth() - 1, 1),`, `      new Date(new Date().getFullYear(), new Date().getMonth(), 0)`, `    ]`, `  }`, `}`, ``, `new coreui.DateRangePicker(myDateRangePickerCustomRanges, optionsCustomRanges)`, ``, `myDateRangePickerCustomRanges.addEventListener('startDateChange.coreui.date-range-picker', event => {`, `  // eslint-disable-next-line no-console`, `  console.log(event.date)`, `})`].join('\n')} />
...
<Example pro lang="html" name="forms-date-range-picker-15" componentName="Date Range Picker" code={`<div class="row">
    <div class="col-sm-6">
...
<Example pro lang="html" name="forms-date-range-picker-16" componentName="Date Range Picker" code={`<div class="row">
    <div class="col-sm-6">
...
<Example pro lang="html" name="forms-date-range-picker-17" componentName="Date Range Picker" code={`<div class="row">
    <div class="col-sm-6">
...
<Example pro lang="html" name="forms-date-range-picker-18" componentName="Date Range Picker" code={`<div class="row">
    <div class="col-sm-6">
...
<Example pro lang="html" name="forms-date-range-picker-19" componentName="Date Range Picker" code={`<div class="row" dir="rtl">
    <div class="col-sm-6">
...
<Example pro lang="html" name="forms-date-range-picker-20" componentName="Date Range Picker" code={`<div class="row" dir="rtl">
    <div class="col-sm-6">

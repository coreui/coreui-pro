...
<Example pro lang="html" name="forms-otp-input-1" componentName="One Time Password (OTP) Input" code={`<label for="basicOTP" class="form-label">Enter OTP Code</label>
...
<Example pro lang="html" name="forms-otp-input-2" componentName="One Time Password (OTP) Input" code={`<div class="mb-3">
...
<Example pro lang="html" name="forms-otp-input-3" componentName="One Time Password (OTP) Input" code={`<div class="mb-3">
...
<Example pro lang="html" name="forms-otp-input-4" componentName="One Time Password (OTP) Input" code={`<label class="form-label">OTP with pre-filled value</label>
...
<Example pro lang="html" name="forms-otp-input-5" componentName="One Time Password (OTP) Input" code={`<div class="mb-3">
...
<Example pro lang="html" name="forms-otp-input-6" componentName="One Time Password (OTP) Input" code={`<form>
...
<Example pro lang="html" name="forms-otp-input-7" componentName="One Time Password (OTP) Input" code={`<div class="mb-3">
...
<Example pro lang="html" name="forms-otp-input-8" componentName="One Time Password (OTP) Input" code={`<div class="mb-3">
...
<Example pro lang="html" name="forms-otp-input-9" componentName="One Time Password (OTP) Input" code={`<label class="form-label">Disabled OTP input</label>
...
<Example pro lang="html" name="forms-otp-input-10" componentName="One Time Password (OTP) Input" code={`<label class="form-label">Readonly OTP input</label>

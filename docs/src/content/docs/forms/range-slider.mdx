...
<Example pro lang="html" name="forms-range-slider-1" componentName="Range Slider" code={`<div data-coreui-toggle="range-slider"
...
<Example pro lang="html" name="forms-range-slider-2" componentName="Range Slider" code={`<div data-coreui-toggle="range-slider" data-coreui-value="50"></div>`} />

## Multiple handles

Enable multiple handles to allow the selection of a range or/and multiple values.

<Example pro lang="html" name="forms-range-slider-3" componentName="Range Slider" code={`<div class="mb-3" data-coreui-toggle="range-slider" data-coreui-value="20,40"></div>
...
<Example pro lang="html" name="forms-range-slider-4" componentName="Range Slider" code={`<div class="d-flex">
...
<Example pro lang="html" name="forms-range-slider-5" componentName="Range Slider" code={`<div class="mb-3" data-coreui-toggle="range-slider" data-coreui-value="50" data-coreui-disabled="true"></div>
...
<Example pro lang="html" name="forms-range-slider-6" componentName="Range Slider" code={`<div class="mb-3" data-coreui-toggle="range-slider" data-coreui-min="-50" data-coreui-max="150" data-coreui-value="50"></div>
...
<Example pro lang="html" name="forms-range-slider-7" componentName="Range Slider" code={`<div class="mb-3" data-coreui-toggle="range-slider" data-coreui-step="0.25" data-coreui-value="50" ></div>
...
<Example pro lang="html" name="forms-range-slider-8" componentName="Range Slider" code={`<div data-coreui-toggle="range-slider" data-coreui-distance="10" data-coreui-value="50, 75"></div>`} />
...
<Example pro lang="html" name="forms-range-slider-9" componentName="Range Slider" code={`<div data-coreui-toggle="range-slider" data-coreui-value="30,70" data-coreui-labels="Start, Middle, End"></div>`} />
...
<Example pro lang="html" name="forms-range-slider-11" componentName="Range Slider" code={`<div data-coreui-toggle="range-slider" data-coreui-clickable-labels="false" data-coreui-value="20,80" data-coreui-labels="Low,Medium,High"></div>`} />

## Tooltips

By default, tooltips display the current value of each handle. You can disable tooltips by setting `tooltips` to `false`

<Example pro lang="html" name="forms-range-slider-12" componentName="Range Slider" code={`<div data-coreui-toggle="range-slider" data-coreui-value="40,60" data-coreui-tooltips="false"></div>`} />
...
<Example pro lang="html" name="forms-range-slider-13" componentName="Range Slider" code={`<div id="myRangeSliderCustomTooltips"></div>`} sandboxJs={[`const myRangeSliderCustomTooltips = document.getElementById('myRangeSliderCustomTooltips')`, ``, `const optionsRangeSliderCustomTooltips = {`, `  max: 1000,`, `  labels: [`, `    {`, `      value: 0,`, `      label: '$0'`, `    },`, `    {`, `      value: 250,`, `      label: '$250'`, `    },`, `    {`, `      value: 500,`, `      label: '$500'`, `    },`, `    {`, `      value: 1000,`, `      label: '$1000'`, `    }`, `  ],`, `  tooltipsFormat: value => \`$\${value}\`,`, `  value: [100, 350]`, `}`, `new coreui.RangeSlider(myRangeSliderCustomTooltips, optionsRangeSliderCustomTooltips)`].join('\n')} />
...
<Example pro lang="html" name="forms-range-slider-14" componentName="Range Slider" code={`<div class="mb-3" data-coreui-toggle="range-slider" data-coreui-track="false" data-coreui-value="50" ></div>

...
<Example pro code={`<div class="form-field">
    ...
    <div data-coreui-range-slider data-coreui-value="25, 75" data-coreui-aria-labels='["Minimum budget", "Maximum budget"]'></div>
...
```html
<div data-coreui-range-slider data-coreui-value="50">
</div>
```

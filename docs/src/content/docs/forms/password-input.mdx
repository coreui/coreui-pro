...
<Example pro lang="html" name="forms-password-input-1" componentName="Password Input" code={`<div class="mb-3">
...
<Example pro lang="html" name="forms-password-input-2" componentName="Password Input" code={`<div class="form-password">
...
<Example pro lang="html" name="forms-password-input-3" componentName="Password Input" code={`<div class="form-password">
...
<Example pro lang="html" name="forms-password-input-4" componentName="Password Input" code={`<div class="form-password">

...
import datePickerDisabledDates2 from './snippets/date-picker-disabled-dates2.js?raw'
import datePickerCustomFormats1 from './snippets/date-picker-custom-formats1.js?raw'
import datePickerCustomFormats2 from './snippets/date-picker-custom-formats2.js?raw'
...
<Example pro code={`<div class="row">
    <div class="col-sm-6 col-lg-5 mb-3 mb-sm-0">
      <div data-coreui-date="2023/03/15 02:22:00 PM" data-coreui-locale="en-US" data-coreui-seconds="false" data-coreui-timepicker="true" data-coreui-toggle="date-picker"></div>
    </div>
    <div class="col-sm-6 col-lg-5">
      <div data-coreui-date="2023/03/15 02:00:00 PM" data-coreui-locale="en-US" data-coreui-minutes="false" data-coreui-seconds="false" data-coreui-timepicker="true" data-coreui-toggle="date-picker"></div>
    </div>
  </div>`} />
...
<Example pro code={`<div class="row">
  ...
  </div>`} sandboxJs={datePickerDisabledDates2} />

<Code code={datePickerDisabledDates2} lang="js" />
...
The `inputDateFormat` property formats the date into a custom string, while the `inputDateParse` property parses a custom string into a Date object. The code showcases the date in different formats based on locale, such as 'MMMM DD, YYYY' and 'YYYY MMMM DD', and accommodates different locales, like 'en-US' and 'es-ES'.

<Example pro code={`<div class="row">
    <div class="col-lg-5">
      <div id="myDatePickerCustomFormats1"></div>
    </div>
  </div>`} sandboxJs={datePickerCustomFormats1} />
...
<Code code={datePickerCustomFormats1} lang="js" />
...
<Example pro code={`<div class="row">
  ...
  </div>`} sandboxJs={datePickerCustomFormats2} />
...
<Code code={datePickerCustomFormats2} lang="js" />

...
<Example pro lang="html" name="forms-multi-select-1" componentName="Multi Select" code={[`<select id="ms1" data-coreui-multi-select multiple data-coreui-search="global">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="ms1" data-coreui-multi-select multiple data-coreui-search="global">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />

<Example pro lang="html" name="forms-multi-select-2" componentName="Multi Select" code={[`<select data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1" disabled>Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4" disabled>Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1" disabled>Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4" disabled>Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-3" componentName="Multi Select" code={[`<select data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0" selected>Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5" selected>Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0" selected>Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5" selected>Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-5" componentName="Multi Select" code={[`<select data-coreui-multi-select multiple>`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select data-coreui-multi-select multiple>`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-6" componentName="Multi Select" code={[`<select data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-7" componentName="Multi Select" code={[`<select data-coreui-multi-select multiple data-coreui-search="global">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select data-coreui-multi-select multiple data-coreui-search="global">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-8" componentName="Multi Select" code={[`<select id="multiple-select-text" data-coreui-multi-select multiple data-coreui-selection-type="text" data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="multiple-select-text" data-coreui-multi-select multiple data-coreui-selection-type="text" data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-9" componentName="Multi Select" code={[`<select id="multiple-select-tag" data-coreui-multi-select multiple data-coreui-selection-type="tags" data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="multiple-select-tag" data-coreui-multi-select multiple data-coreui-selection-type="tags" data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-10" componentName="Multi Select" code={[`<select id="multiple-select-counter" data-coreui-multi-select multiple data-coreui-selection-type="counter" data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="multiple-select-counter" data-coreui-multi-select multiple data-coreui-selection-type="counter" data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-11" componentName="Multi Select" code={[`<select id="multiSelectSelectAll" data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="multiSelectSelectAll" data-coreui-multi-select multiple data-coreui-search="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-12" componentName="Multi Select" code={[`<select id="multiSelectSelectAllMode" data-coreui-multi-select multiple data-coreui-search="true" data-coreui-select-all-mode="filtered">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="multiSelectSelectAllMode" data-coreui-multi-select multiple data-coreui-search="true" data-coreui-select-all-mode="filtered">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-14" componentName="Multi Select" code={[`<select id="single-select" data-coreui-multi-select data-coreui-multiple="false">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="single-select" data-coreui-multi-select data-coreui-multiple="false">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-15" componentName="Multi Select" code={[`<select id="ms1" data-coreui-multi-select multiple data-coreui-search="true"  data-coreui-disabled="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} html={[`<select id="ms1" data-coreui-multi-select multiple data-coreui-search="true"  data-coreui-disabled="true">`, `  <option value="0">Angular</option>`, `  <option value="1">Bootstrap</option>`, `  <option value="2">React.js</option>`, `  <option value="3">Vue.js</option>`, `  <optgroup label="backend">`, `    <option value="4">Django</option>`, `    <option value="5">Laravel</option>`, `    <option value="6">Node.js</option>`, `  </optgroup>`, `</select>`]} />
...
<Example pro lang="html" name="forms-multi-select-19" componentName="Multi Select" code={[`<div class="row">`, `  <div class="col-md-6">`, `    <select id="multiple-select-counter" class="form-multi-select-lg mb-3" data-coreui-multi-select data-coreui-selection-type="counter" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `    <select id="multiple-select-counter" class="form-multi-select-sm" data-coreui-multi-select data-coreui-selection-type="counter" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `  </div>`, `  <div class="col-md-6">`, `    <select id="multiple-select-counter" class="form-multi-select-lg mb-3" data-coreui-multi-select data-coreui-selection-type="tags" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `    <select id="multiple-select-counter" class="form-multi-select-sm" data-coreui-multi-select data-coreui-selection-type="tags" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-md-6">`, `    <select id="multiple-select-counter" class="form-multi-select-lg mb-3" data-coreui-multi-select data-coreui-selection-type="counter" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `    <select id="multiple-select-counter" class="form-multi-select-sm" data-coreui-multi-select data-coreui-selection-type="counter" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `  </div>`, `  <div class="col-md-6">`, `    <select id="multiple-select-counter" class="form-multi-select-lg mb-3" data-coreui-multi-select data-coreui-selection-type="tags" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `    <select id="multiple-select-counter" class="form-multi-select-sm" data-coreui-multi-select data-coreui-selection-type="tags" data-coreui-search="true">`, `      <option value="0">Angular</option>`, `      <option value="1">Bootstrap</option>`, `      <option value="2">React.js</option>`, `      <option value="3">Vue.js</option>`, `      <optgroup label="backend">`, `        <option value="4">Django</option>`, `        <option value="5">Laravel</option>`, `        <option value="6">Node.js</option>`, `      </optgroup>`, `    </select>`, `  </div>`, `</div>`]} />

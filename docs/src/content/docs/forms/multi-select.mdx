...
| `ariaPickerLabel` | string | `'Toggle visibility of options menu'` | Accessible label of the picker button. |
...
<ScssDocs file="scss/forms/_form-multi-select.scss" capture="form-multi-select-variables" />

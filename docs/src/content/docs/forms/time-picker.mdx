...
<Example pro lang="html" name="forms-time-picker-1" componentName="Time Picker" code={`<div class="row">
...
<Example pro lang="html" name="forms-time-picker-2" componentName="Time Picker" code={`<div class="row">
...
<Example pro lang="html" name="forms-time-picker-3" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
...
<Example pro lang="html" name="forms-time-picker-4" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
...
<Example pro lang="html" name="forms-time-picker-5" componentName="Time Picker" code={`<div class="row">
    <div class="col-sm-6 col-lg-5 mb-3 mb-sm-0">
...
<Example pro lang="html" name="forms-time-picker-6" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
      <div id="myTimePickerCustom"></div>
    </div>
  </div>`} sandboxJs={[`const myTimePickerCustom = document.getElementById('myTimePickerCustom')`, ``, `const options = {`, `  locale: 'en-US',`, `  hours: [1, 3, 5, 7],`, `  minutes: [0, 15, 30, 45],`, `  seconds: s => s < 20`, `}`, ``, `new coreui.TimePicker(myTimePickerCustom, options)`].join('\n')} />
...
<Example pro lang="html" name="forms-time-picker-7" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
...
<Example pro lang="html" name="forms-time-picker-8" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
...
<Example pro lang="html" name="forms-time-picker-9" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
...
<Example pro lang="html" name="forms-time-picker-10" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
...
<Example pro lang="html" name="forms-time-picker-11" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">
...
<Example pro lang="html" name="forms-time-picker-12" componentName="Time Picker" code={`<div class="row">
    <div class="col-lg-4">

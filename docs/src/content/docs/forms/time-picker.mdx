...
<Example pro lang="html" name="forms-time-picker-1" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-sm-6 col-lg-5 mb-3 mb-sm-0">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-toggle="time-picker" id="timePicker1"></div>`, `  </div>`, `  <div class="col-sm-6 col-lg-5">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-time="02:17:35 PM" data-coreui-toggle="time-picker" id="timePicker2"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-sm-6 col-lg-5 mb-3 mb-sm-0">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-toggle="time-picker" id="timePicker1"></div>`, `  </div>`, `  <div class="col-sm-6 col-lg-5">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-time="02:17:35 PM" data-coreui-toggle="time-picker" id="timePicker2"></div>`, `  </div>`, `</div>`]} />

## Sizing

Set heights using `data-coreui-size` attribute like `data-coreui-size="lg"` and `data-coreui-size="sm"`.

<Example pro lang="html" name="forms-time-picker-2" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-5 mb-3">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-size="lg" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`, `<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-size="sm" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-5 mb-3">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-size="lg" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`, `<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-size="sm" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />

## Disabled

Add the `data-coreui-disabled="true"` attribute on an input to give it a grayed out appearance and remove pointer events.

<Example pro lang="html" name="forms-time-picker-3" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-disabled="true" data-coreui-locale="en-US" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-disabled="true" data-coreui-locale="en-US" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />

## Readonly

Add the `data-coreui-input-read-only="true"` boolean attribute to prevent modification of the input's value.

<Example pro lang="html" name="forms-time-picker-4" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-input-read-only="true" data-coreui-locale="en-US" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-input-read-only="true" data-coreui-locale="en-US" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />
...
<Example pro lang="html" name="forms-time-picker-5" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-sm-6 col-lg-5 mb-3 mb-sm-0">`, `    <label class="form-label">Only hours and minutes</label>`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-seconds="false" data-coreui-toggle="time-picker"></div>`, `  </div>`, `  <div class="col-sm-6 col-lg-5">`, `  <label class="form-label">Only hours</label>`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-minutes="false" data-coreui-seconds="false" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-sm-6 col-lg-5 mb-3 mb-sm-0">`, `    <label class="form-label">Only hours and minutes</label>`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-seconds="false" data-coreui-toggle="time-picker"></div>`, `  </div>`, `  <div class="col-sm-6 col-lg-5">`, `  <label class="form-label">Only hours</label>`, `    <div class="time-picker" data-coreui-locale="en-US" data-coreui-minutes="false" data-coreui-seconds="false" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />
...
<Example pro lang="html" name="forms-time-picker-6" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div id="myTimePickerCustom"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div id="myTimePickerCustom"></div>`, `  </div>`, `</div>`]} sandboxJs={[`const myTimePickerCustom = document.getElementById('myTimePickerCustom')`, ``, `const options = {`, `  locale: 'en-US',`, `  hours: [1, 3, 5, 7],`, `  minutes: [0, 15, 30, 45],`, `  seconds: s => s < 20`, `}`, ``, `new coreui.TimePicker(myTimePickerCustom, options)`].join('\n')} />
...
<Example pro lang="html" name="forms-time-picker-7" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />

### Chinese

To configure the Time Picker for Chinese users, set the locale to `zh-CN` and provide a placeholder text:

<Example pro lang="html" name="forms-time-picker-8" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="zh-CN" data-coreui-placeholder="入住日期" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="zh-CN" data-coreui-placeholder="入住日期" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />

### Japanese

To localize the Time Picker for Japanese, set the locale to `ja` and use an appropriate placeholder:

<Example pro lang="html" name="forms-time-picker-9" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="ja" data-coreui-placeholder="日付を選択" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="ja" data-coreui-placeholder="日付を選択" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />

### Korean

For Korean localization, set the locale to `ko` and include placeholder text:

<Example pro lang="html" name="forms-time-picker-10" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="ko" data-coreui-placeholder="날짜 선택" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="ko" data-coreui-placeholder="날짜 선택" data-coreui-toggle="time-picker"></div>`, `  </div>`, `</div>`]} />
...
<Example pro lang="html" name="forms-time-picker-11" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="he-IL" data-coreui-placeholder="בחר תאריך" data-coreui-toggle="time-picker" dir="rtl"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="he-IL" data-coreui-placeholder="בחר תאריך" data-coreui-toggle="time-picker" dir="rtl"></div>`, `  </div>`, `</div>`]} />

### Persian

<Example pro lang="html" name="forms-time-picker-12" componentName="Time Picker" code={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="fa-IR" data-coreui-placeholder="تاریخ شروع" data-coreui-toggle="time-picker" dir="rtl"></div>`, `  </div>`, `</div>`]} html={[`<div class="row">`, `  <div class="col-lg-4">`, `    <div class="time-picker" data-coreui-locale="fa-IR" data-coreui-placeholder="تاریخ شروع" data-coreui-toggle="time-picker" dir="rtl"></div>`, `  </div>`, `</div>`]} />
...
<ScssDocs file="scss/_variables.scss" capture="time-picker-variables" />

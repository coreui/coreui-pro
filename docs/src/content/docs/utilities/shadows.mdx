...
<Example code={`<div class="d-flex flex-wrap gap-4">
    ...
    <div class="shadow shadow-current p-3 bg-body rounded fg-info">Current color</div>
  </div>`} />
...
`.shadow-opacity-{10…100}`, in steps of ten, scales the shadow without touching its colour or geometry, which is the usual way to soften a shadow on a busy surface. `.shadow-opacity-25` and `-75` are deprecated v5 steps, removed in v7.

<Example code={`<div class="d-flex flex-wrap gap-4">
    <div class="shadow shadow-opacity-30 p-3 bg-body rounded">30%</div>
    <div class="shadow shadow-opacity-50 p-3 bg-body rounded">50%</div>
    <div class="shadow shadow-opacity-70 p-3 bg-body rounded">70%</div>

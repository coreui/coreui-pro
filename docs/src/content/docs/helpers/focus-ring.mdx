...
<Example code={`<a href="#" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style="--cui-focus-ring-color: color-mix(in srgb, var(--cui-success-base) 25%, transparent)">
    Green focus ring
  </a>`} />

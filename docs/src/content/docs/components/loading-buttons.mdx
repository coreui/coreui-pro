...
<Example pro lang="html" name="components-loading-buttons-1" componentName="Loading Buttons" code={`<button type="button" class="btn btn-primary" data-coreui-timeout="2000" data-coreui-toggle="loading-button">Submit</button>
...
<Example pro lang="html" name="components-loading-buttons-2" componentName="Loading Buttons" code={`<button type="button" class="btn btn-info" data-coreui-toggle="loading-button">Submit</button>
...
<Example pro lang="html" name="components-loading-buttons-3" componentName="Loading Buttons" code={`<button type="button" class="btn btn-info" data-coreui-spinner-type="grow" data-coreui-toggle="loading-button">Submit</button>

...
<Example class="tooltip-demo" code={`<button type="button" class="btn btn-outline"
...
<Example class="tooltip-demo" code={`<button type="button" class="btn btn-outline" data-coreui-toggle="tooltip" data-coreui-placement="top" title="Tooltip on top">Tooltip on top</button>
...
<Example class="tooltip-demo" code={`<button type="button" class="btn btn-outline" data-coreui-toggle="tooltip" data-coreui-html="true" title="<em>Tooltip</em> <u>with</u> <b>HTML</b>">
    Tooltip with HTML
  </button>`} />
...
<Example class="tooltip-demo" code={`<a href="#" class="d-inline-block" data-coreui-toggle="tooltip" title="Default tooltip">
...
<Example class="tooltip-demo" code={`<span class="d-inline-block" tabindex="0" data-coreui-toggle="tooltip" title="Disabled tooltip">

...
<Example lang="html" name="components-tooltips-1" componentName="Tooltips" class="tooltip-demo" code={`<button type="button" class="btn btn-outline"
...
<Example lang="html" name="components-tooltips-2" componentName="Tooltips" class="tooltip-demo" code={`<button type="button" class="btn btn-outline" data-coreui-toggle="tooltip" data-coreui-placement="top" title="Tooltip on top">Tooltip on top</button>
...
<Example lang="html" name="components-tooltips-3" componentName="Tooltips" class="tooltip-demo" code={`<button type="button" class="btn btn-outline" data-coreui-toggle="tooltip" data-coreui-html="true" title="<em>Tooltip</em> <u>with</u> <b>HTML</b>">
    Tooltip with HTML
  </button>`} />
...
<Example lang="html" name="components-tooltips-5" componentName="Tooltips" class="tooltip-demo" code={`<span class="d-inline-block" tabindex="0" data-coreui-toggle="tooltip" title="Disabled tooltip">

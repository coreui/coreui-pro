...
<Example code={`<a class="btn btn-primary" href="#" role="button" data-coreui-toggle="menu" aria-expanded="false">
  ...
  <div class="btn-group">
    ...
    <button type="button" class="btn btn-secondary dropdown-toggle-split" data-coreui-toggle="menu" aria-expanded="false">
...
<Example code={`<div class="d-flex">
    ...
    <div class="btn-group">
      ...
      <button type="button" class="btn btn-secondary dropdown-toggle-split" data-coreui-toggle="menu" aria-expanded="false" data-coreui-reference="parent">
        <span class="visually-hidden">Toggle Menu</span>
      </button>
      <div class="menu">
        <a class="menu-item" href="#">Action</a>

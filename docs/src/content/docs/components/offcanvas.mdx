...
<Example lang="html" name="components-offcanvas-1" componentName="Offcanvas" class="docs-example-offcanvas p-0 bg-light overflow-hidden" code={`<div class="offcanvas offcanvas-start show" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
...
<Example lang="html" name="components-offcanvas-2" componentName="Offcanvas" code={`<a class="btn btn-primary" data-coreui-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
    Link with href
  </a>
...
<Example lang="html" name="components-offcanvas-3" componentName="Offcanvas" code={`<button class="btn btn-primary" type="button" data-coreui-toggle="offcanvas" data-coreui-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">Enable body scrolling</button>
...
<Example lang="html" name="components-offcanvas-4" componentName="Offcanvas" code={`<button class="btn btn-primary" type="button" data-coreui-toggle="offcanvas" data-coreui-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">Enable both scrolling & backdrop</button>
...
<Example lang="html" name="components-offcanvas-5" componentName="Offcanvas" code={`<button class="btn btn-primary" type="button" data-coreui-toggle="offcanvas" data-coreui-target="#staticBackdrop" aria-controls="staticBackdrop">
...
<Example lang="html" name="components-offcanvas-6" componentName="Offcanvas" class="docs-example-offcanvas p-0 bg-body-secondary overflow-hidden" code={`<div class="offcanvas offcanvas-start show text-bg-dark" tabindex="-1" id="offcanvasDark" aria-labelledby="offcanvasDarkLabel">
    <div class="offcanvas-header">
...
<Example lang="html" name="components-offcanvas-7" componentName="Offcanvas" code={`<button class="btn btn-primary d-lg-none" type="button" data-coreui-toggle="offcanvas" data-coreui-target="#offcanvasResponsive" aria-controls="offcanvasResponsive">Toggle offcanvas</button>
...
<Example lang="html" name="components-offcanvas-8" componentName="Offcanvas" code={`<button class="btn btn-primary" type="button" data-coreui-toggle="offcanvas" data-coreui-target="#offcanvasTop" aria-controls="offcanvasTop">Toggle top offcanvas</button>
...
<Example lang="html" name="components-offcanvas-9" componentName="Offcanvas" code={`<button class="btn btn-primary" type="button" data-coreui-toggle="offcanvas" data-coreui-target="#offcanvasRight" aria-controls="offcanvasRight">Toggle right offcanvas</button>
...
<Example lang="html" name="components-offcanvas-10" componentName="Offcanvas" code={`<button class="btn btn-primary" type="button" data-coreui-toggle="offcanvas" data-coreui-target="#offcanvasBottom" aria-controls="offcanvasBottom">Toggle bottom offcanvas</button>

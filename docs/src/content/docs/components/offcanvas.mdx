...
<Example class="docs-example-offcanvas p-0 bg-body-secondary overflow-hidden" code={`<dialog class="offcanvas offcanvas-start" id="offcanvas" aria-labelledby="offcanvasLabel" open>
...
<Example class="docs-example-offcanvas p-0 bg-body-secondary overflow-hidden" code={`<dialog class="offcanvas offcanvas-start text-bg-inverse" id="offcanvasDark" aria-labelledby="offcanvasDarkLabel" open>
    <div class="offcanvas-header">

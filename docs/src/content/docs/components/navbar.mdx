...
This example uses [background](/utilities/background/) (`bg-body-tertiary"`) and [spacing](/utilities/margin/) (`me-auto`, `mb-2`, `mb-lg-0`, `me-2`) utility classes.
...
<Example code={`<div class="collapse" id="navbarToggleExternalContent" data-coreui-theme="dark">
    <div class="bg-body-tertiary p-4" data-coreui-theme="dark">
      <h5 class="text-white h4">Collapsed content</h5>
      <span class="text-body-secondary">Toggleable via the navbar brand.</span>
    </div>
  </div>
  <nav class="navbar bg-body-tertiary" data-coreui-theme="dark">
    <div class="container-fluid">
...
<Example code={`<nav class="navbar bg-body-tertiary fixed-top" data-coreui-theme="dark">
    <div class="container-fluid">

...
<Example code={`<div class="p-5 mb-4 bg-3 rounded-3">
    <h1 class="fs-6xl fw-light lh-1">Hello, world!</h1>
    <p class="fs-lg fw-light">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
    <hr class="my-4">
...
<Example code={`<div class="p-5 text-center bg-3">
...
<Example code={`<div class="row align-items-md-stretch">
    <div class="col-md-6">
      <div class="h-100 p-5 bg-black fg-white rounded-3" data-coreui-theme="dark">

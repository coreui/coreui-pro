...
<Example lang="html" name="components-chip-1" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
...
<Example lang="html" name="components-chip-2" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
...
<Example lang="html" name="components-chip-3" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
    <span class="chip">
...
<Example lang="html" name="components-chip-4" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
    <span class="chip">
...
<Example lang="html" name="components-chip-5" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
...
<Example lang="html" name="components-chip-6" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
...
<Example lang="html" name="components-chip-7" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
...
<Example lang="html" name="components-chip-8" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1 mb-3">
...
<Example lang="html" name="components-chip-9" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">
...
<Example lang="html" name="components-chip-10" componentName="Chip" code={`<div class="d-flex flex-wrap gap-1">

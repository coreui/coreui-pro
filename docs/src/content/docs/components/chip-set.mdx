...
<Example lang="html" name="components-chip-set-1" componentName="Chip set" code={`<div class="chip-set" data-coreui-chip-set>
...
<Example lang="html" name="components-chip-set-2" componentName="Chip set" code={`<div class="chip-set" data-coreui-chip-set data-coreui-selectable="true">
...
<Example lang="html" name="components-chip-set-3" componentName="Chip set" code={`<div class="chip-set" data-coreui-chip-set data-coreui-selectable="true" data-coreui-selection-mode="single">
...
<Example lang="html" name="components-chip-set-4" componentName="Chip set" code={`<div class="chip-set" data-coreui-chip-set data-coreui-filter="true">
    <span class="chip">Design</span>
    <span class="chip active">Development</span>
    <span class="chip">Marketing</span>
    <span class="chip active">Sales</span>
...
<Example lang="html" name="components-chip-set-5" componentName="Chip set" code={`<div class="chip-set" data-coreui-chip-set data-coreui-removable="true">

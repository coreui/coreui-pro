...
<Example lang="html" name="components-collapse-1" componentName="Collapse" code={`<p class="d-inline-flex gap-1">
...
<Example lang="html" name="components-collapse-2" componentName="Collapse" code={`<p>
...
<Example lang="html" name="components-collapse-3" componentName="Collapse" code={`<p class="d-inline-flex gap-1">

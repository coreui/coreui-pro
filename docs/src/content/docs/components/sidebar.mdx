...
<Example class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar border-end h-100">
...
<Example class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar sidebar-narrow border-end">
...
<Example class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar sidebar-narrow-unfoldable border-end">
    <div class="sidebar-header">
      <div class="sidebar-brand">
        <svg role="img" aria-label="CoreUI Logo Full" class="d-sidebar-narrow-none" width="88" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 312 115">
          <g style="fill: currentColor">
...
<Example class="bg-body-secondary p-0 rounded-bottom-0 overflow-hidden" code={`<div class="sidebar border-end">

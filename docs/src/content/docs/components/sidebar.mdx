...
<ScssDocs file="scss/sidebar/_sidebar.scss" capture="sidebar-tokens" />

<ScssDocs file="scss/sidebar/_sidebar.scss" capture="sidebar-overlaid-tokens" />

<ScssDocs file="scss/sidebar/_sidebar-narrow.scss" capture="sidebar-narrow-tokens" />

<ScssDocs file="scss/sidebar/_sidebar-narrow.scss" capture="sidebar-narrow-unfoldable-tokens" />

<ScssDocs file="scss/sidebar/_sidebar-nav.scss" capture="sidebar-nav-tokens" />

<ScssDocs file="scss/sidebar/_sidebar-nav.scss" capture="sidebar-nav-tree-tokens" />

<ScssDocs file="scss/sidebar/_sidebar.scss" capture="sidebar-toggler-tokens" />

<ScssDocs file="scss/sidebar/_sidebar.scss" capture="sidebar-backdrop-tokens" />

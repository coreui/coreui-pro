...
<Example class="p-0 rounded-bottom-0 overflow-hidden d-flex gap-0" code={getData('theme-colors').map((c) => `<div class="sidebar theme-${c.name}" style="--cui-sidebar-width: 12rem">
    <div class="sidebar-header"><div class="sidebar-brand">${c.title}</div></div>
    <ul class="sidebar-nav">
      <li class="nav-item"><a class="nav-link active" href="#"><svg class="nav-icon"><use xlink:href="/bootstrap/docs/assets/icons/free.svg#cil-speedometer"></use></svg> Active</a></li>
      <li class="nav-item"><a class="nav-link" href="#"><svg class="nav-icon"><use xlink:href="/bootstrap/docs/assets/icons/free.svg#cil-puzzle"></use></svg> Link</a></li>
    </ul>
  </div>`)} />

...
<Example code={`<button type="button" class="btn btn-primary rounded-pill">Primary</button>
...
<Example code={`<button type="button" class="btn btn-primary rounded-0">Primary</button>

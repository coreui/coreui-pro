...
- Use our [spacing](/utilities/spacing/) and [flex](/utilities/flex/) utility classes for controlling spacing and alignment within headers.
...
This example uses [color](/utilities/colors/) (`bg-light`) and [spacing](/utilities/spacing/) (`my-2`, `my-lg-0`, `mr-sm-0`, `my-sm-0`) utility classes.

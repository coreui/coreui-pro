...
<Example lang="html" name="components-dropdowns-1" componentName="Dropdowns" code={`<div class="dropdown">
...
<Example lang="html" name="components-dropdowns-2" componentName="Dropdowns" code={`<div class="dropdown">
...
<Example lang="html" name="components-dropdowns-3" componentName="Dropdowns" code={`<div class="dropdown">
    <button class="btn btn-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">
      Dropdown button
    </button>
...
<Example lang="html" name="components-dropdowns-4" componentName="Dropdowns" code={`<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
...
<Example lang="html" name="components-dropdowns-5" componentName="Dropdowns" code={`<div class="dropdown-center">
    <button class="btn btn-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">
      Centered dropdown
    </button>
    <ul class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-6" componentName="Dropdowns" code={`<div class="dropup-center dropup">
    <button class="btn btn-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">
      Centered dropup
    </button>
    <ul class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-7" componentName="Dropdowns" code={`<div class="dropdown">
    <button class="btn btn-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">
      Dropdown
    </button>
    <ul class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-8" componentName="Dropdowns" code={`<ul class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-9" componentName="Dropdowns" code={`<ul class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-10" componentName="Dropdowns" code={`<ul class="dropdown-menu">
    <li><a class="dropdown-item" href="#">Regular link</a></li>
...
<Example lang="html" name="components-dropdowns-11" componentName="Dropdowns" code={`<div class="btn-group">
    <button type="button" class="btn btn-secondary dropdown-toggle" data-coreui-toggle="dropdown" aria-expanded="false">
...
<Example lang="html" name="components-dropdowns-12" componentName="Dropdowns" code={`<div class="btn-group">
...
<Example lang="html" name="components-dropdowns-13" componentName="Dropdowns" code={`<div class="btn-group">
    <button type="button" class="btn btn-secondary dropdown-toggle" data-coreui-toggle="dropdown" data-coreui-display="static" aria-expanded="false">
...
<Example lang="html" name="components-dropdowns-14" componentName="Dropdowns" code={`<div class="btn-group">
    <button class="btn btn-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">
      Dropdown
    </button>
    <ul class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-15" componentName="Dropdowns" code={`<ul class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-16" componentName="Dropdowns" code={`<ul class="dropdown-menu">
    <li><a class="dropdown-item" href="#">Action</a></li>
    <li><a class="dropdown-item" href="#">Another action</a></li>
    <li><a class="dropdown-item" href="#">Something else here</a></li>
    <li><hr class="dropdown-divider"></li>
...
<Example lang="html" name="components-dropdowns-17" componentName="Dropdowns" code={`<div class="dropdown-menu p-4 text-body-secondary" style="max-width: 200px;">
    <p>
...
<Example lang="html" name="components-dropdowns-18" componentName="Dropdowns" code={`<div class="dropdown-menu">
...
<Example lang="html" name="components-dropdowns-19" componentName="Dropdowns" code={`<div class="dropdown">
...
<Example lang="html" name="components-dropdowns-20" componentName="Dropdowns" code={`<div class="d-flex">
...
<Example lang="html" name="components-dropdowns-21" componentName="Dropdowns" code={`<div class="btn-group">

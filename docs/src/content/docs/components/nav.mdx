...
<ScssDocs file="scss/_nav.scss" capture="nav-tokens" />

On the `.nav-tabs` modifier class:

<ScssDocs file="scss/_nav.scss" capture="nav-tabs-tokens" />

On the `.nav-pills` modifier class:

<ScssDocs file="scss/_nav.scss" capture="nav-pills-tokens" />

<AddedIn version="5.0.0" />

On the `.nav-underline` modifier class:

<ScssDocs file="scss/_nav.scss" capture="nav-underline-tokens" />

<AddedIn version="5.0.0" />

On the `.nav-underline-border` modifier class:

<ScssDocs file="scss/_nav.scss" capture="nav-underline-border-tokens" />

Tab pane variables:

<ScssDocs file="scss/_nav.scss" capture="tab-pane-tokens" />

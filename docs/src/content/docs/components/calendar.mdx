...
The month and year between the navigation arrows sit in a polite live region, so turning a page announces where it landed. In the years view that is the range of years the page shows, the same text as the grid's label.

...
<Example pro lang="html" name="components-calendar-1" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div
...
<Example pro lang="html" name="components-calendar-2" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div
      class="border rounded"
      data-coreui-locale="en-US"
...
<Example pro lang="html" name="components-calendar-3" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div 
      class="border rounded"
      data-coreui-locale="en-US"
...
<Example pro lang="html" name="components-calendar-4" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div
      class="border rounded"
      data-coreui-locale="en-US"
...
<Example pro lang="html" name="components-calendar-5" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div 
      class="border rounded"
      data-coreui-locale="en-US"
...
<Example pro lang="html" name="components-calendar-6" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div 
      class="border rounded"
...
<Example pro lang="html" name="components-calendar-7" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div 
      class="border rounded"
      data-coreui-locale="en-US"
      data-coreui-calendars="2"
...
<Example pro lang="html" name="components-calendar-8" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div id="myCalendarDisabledDates" class="border rounded"></div>
  </div>`} sandboxJs={[`const myCalendarDisabledDates = document.getElementById('myCalendarDisabledDates')`, ``, `const optionsCalendarDisabledDates = {`, `  calendarDate: new Date(2022, 2, 1),`, `  calendars: 2,`, `  disabledDates: [`, `    [new Date(2022, 2, 4), new Date(2022, 2, 7)],`, `    new Date(2022, 2, 16),`, `    new Date(2022, 3, 16),`, `    [new Date(2022, 4, 2), new Date(2022, 4, 8)]`, `  ],`, `  locale: 'en-US',`, `  maxDate: new Date(2022, 5, 0),`, `  minDate: new Date(2022, 1, 1)`, `}`, ``, `new coreui.Calendar(myCalendarDisabledDates, optionsCalendarDisabledDates)`].join('\n')} />
...
<Example pro lang="html" name="components-calendar-9" componentName="Calendar" code={`<div class="d-flex justify-content-center">
    <div id="myCalendarDisabledDates2" class="border rounded"></div>
  </div>`} sandboxJs={[`const myCalendarDisabledDates2 = document.getElementById('myCalendarDisabledDates2')`, ``, `const optionsCalendarDisabledDates2 = {`, `  calendars: 2,`, `  disabledDates(date) {`, `    const day = date.getDay()`, `    return day === 0 || day === 6`, `  },`, `  locale: 'en-US'`, `}`, ``, `new coreui.Calendar(myCalendarDisabledDates2, optionsCalendarDisabledDates2)`].join('\n')} />
...
<Example pro lang="html" name="components-calendar-11" componentName="Calendar" code={`<div class="d-flex justify-content-center">
...
<Example pro lang="html" name="components-calendar-12" componentName="Calendar" code={`<div class="d-flex justify-content-center">
...
<Example pro lang="html" name="components-calendar-13" componentName="Calendar" code={`<div class="d-flex justify-content-center">
...
<Example pro lang="html" name="components-calendar-14" componentName="Calendar" code={`<div class="d-flex justify-content-center" dir="rtl">
...
<Example pro lang="html" name="components-calendar-15" componentName="Calendar" code={`<div class="d-flex justify-content-center" dir="rtl">
...
<Example pro lang="html" name="components-calendar-16" componentName="Calendar" code={`<div class="d-flex justify-content-center">

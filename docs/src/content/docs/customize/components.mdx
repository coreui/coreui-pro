...
| `--cui-theme-fg` | Emphasis foreground — the theme's readable text color |
| `--cui-theme-fg-base` | Foreground one step lighter than the emphasis text |
...
| `--cui-theme-focus-ring` | The focus ring, in the theme's hue |

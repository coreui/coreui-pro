...
<ScssDocs file="scss/_config.scss" capture="color-scale-variables" />
...
<ScssDocs file="scss/forms/_form-select.scss" capture="form-select-dark-variables" />

<ScssDocs file="scss/forms/_check.scss" capture="form-switch-dark-variables" />

...
You will find the complete list of CoreUI for Bootstrap's variables in `scss/_config.scss`. Some variables are set to `null`, these variables don't output the property unless they are overridden in your configuration.

...
Control the total number of rating items displayed by using `data-coreui-max`. You can create a Rating component with a custom scale, be it larger for detailed assessments or smaller for simplicity.

{{< example >}}
<div data-coreui-max="20" data-coreui-toggle="rating" data-coreui-value="5"></div>
{{< /example >}}

{{< example >}}
<div data-coreui-max="3" data-coreui-toggle="rating" data-coreui-value="1"></div>
{{< /example >}}
...
{{< js-docs name="range-custom-icons1" file="docs/assets/js/snippets.js" >}}
...
{{< js-docs name="range-custom-icons2" file="docs/assets/js/snippets.js" >}}
...
{{< js-docs name="range-custom-icons3" file="docs/assets/js/snippets.js" >}}

...
- Added [new Parcel guide](https://coreui.io/docs/4.1/getting-started/parcel/).
- Added [new Customize section](https://coreui.io/docs/4.1/customize/overview/).
- Reorganized all form documentation into [new Forms section](https://coreui.io/docs/4.1/forms/overview/), breaking apart the content into more focused pages.
- Similarly, updated [the Layout section](https://coreui.io/docs/4.1/layout/breakpoints/), to flesh out grid content more clearly.
...
- **Improved gutters.** Gutters are now set in rems, and are narrower than v4 (`1.5rem`, or about `24px`, down from `30px`). This aligns our grid system's gutters with our spacing utilities.
  - Added new [gutter class](https://coreui.io/docs/4.1/layout/gutters/) (`.g-*`, `.gx-*`, and `.gy-*`) to control horizontal/vertical gutters, horizontal gutters, and vertical gutters.

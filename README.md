...
- [Download the latest release](https://github.com/coreui/coreui-pro/archive/v5.4.0.zip)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui-pro:5.4.0`

...
- [Download the latest release](https://github.com/coreui/coreui-pro/archive/v5.26.0.zip) (CoreUI PRO Enterprise subscription required)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui-pro:5.26.0`

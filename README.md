...
- [Download the latest release](https://github.com/coreui/coreui-pro/archive/v6.0.0-alpha.0.zip) (CoreUI PRO Enterprise subscription required)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui-pro:6.0.0-alpha.0`

...
- [Download the latest release](https://github.com/coreui/coreui-pro/archive/v5.0.0-rc.2.zip)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui:5.0.0-rc.2`

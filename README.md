...
- [Download the latest release](https://github.com/coreui/coreui/archive/v4.2.0-beta.0.zip)
...
- Install with [Composer](https://getcomposer.org/): `composer require coreui/coreui:4.2.0-beta.0`
